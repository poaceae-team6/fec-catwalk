...
To increase performance, we used react-compression and react-lazy-load. We also focused on our accesibility scores, making sure all images and buttons have alt text description. Below is a screenshot of our site after deployed onto AWS using EC2.
